...
const BUDGET = {
  phone: {
    height: 4065, // px, 3660 before the default Mun mission gained a transfer card (#223) — the whole page with the default mission solved and the brief set: 3590 once the staging chips became stops on the scrubber (#210), 3740 before with the works number and the footer's first line (#207), 3749 after #190, with 2% for a different Chrome's fonts
    words: 595, // 555 before the default Mun mission gained a transfer card (#223): its caption, its figures and their notes. visible words on that page — the paragraphs are behind disclosures, #135. 573 before the staging chips became stops with short labels (#210); 559 once the header's install line moved into Setup (#207), then 14 back on purpose for the footer's first line and the works number. 617 before #190
    tinyText: 0, // text under 12 px
    smallBody: 64, // 57 before the Mun transfer card (#223) brought a caption and its figures' notes; text under 13 px: the labels, at 12 — two more on purpose, the stop labels under the scrubber (#210); 55 after #207 took one from the header, 59 before #190
  ...
  desktop: {
    height: 2793, // 2364 before the default Mun mission gained a transfer card (#223); 2338 once the header lost its install line (#207); 2359 before, the two-column shell (#137) with the rocket at six tenths of the window (#138); 2529 before #190
    words: 610, // 570 before the default Mun mission gained a transfer card (#223). 556 once the header's install line moved into Setup (#207), then 14 back on purpose for the footer's first line and the works number; 620 before #190
    tinyText: 67, // 60 before the Mun transfer card (#223); the labels, at 11 — 61 before #207 took the header's install line; raised from 60 with #190's four-stage default rocket
    smallBody: 103, // 86 before the Mun transfer card (#223): its caption and the notes under its figures // labels and notes — 87 before #207
